...
export default function AdminLayout({ children }) {
  ...
  const navigation = [
    ...
    // Utilizatori - vizibil pentru toți adminii
    { name: "Utilizatori", href: "/admin/all-users", icon: AllUsersIcon },
    // Mesaje Contact - vizibil pentru toți adminii
    { name: "Mesaje Contact", href: "/admin/contacts", icon: ContactIcon },
    // Abonați Newsletter - vizibil pentru toți adminii
    { name: "Abonați", href: "/admin/subscribers", icon: SubscribersIcon },
...
function AllUsersIcon({ className }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
